...
- Name:莫班傑(MORIN, BENJAMIN)
- number:T15902206
- Research Direction: integrated sensing and communication
- Briefly summarize your background and why you want to take this course: I am a 4th year software engineering student at Polytechnique Montréal. I am currently doing an exchange semester at NTU. I want to take this class in order to deepen my understanding of wireless networks. I know that this subject is relevant for any person studying technology since almost every software uses networks to transmit information in some way ore another, and wireless networks are almost always the ones used to do so.
...
In this lab, you will use Wireshark to analyze how a UE establishes an RRC connection with an OAI gNB and then registers with the 5G Core.
    - delivery: [Lab0](lab0.md) and [Lab1](lab1.md)
